...
for i = 1:length(newEdge)
    xlswrite(strcat('Z:\Taylor\Code\Benchmarking_Extended\RyallHypertrophy_',num2str(i),'.xlsx'),[{'middle'},{'r195'},newEdge(i),1,1.223,0.5],'reactions','A197'); %r194 & A196 for RyallHypertrophy
end
...
% % %             xlswrite(strcat('Z:\Taylor\Code\Benchmarking_Extended\RyallHypertrophy_',num2str(count),'.xlsx'),[{'middle'},{'r195'},newEdge(i),1,1.223,0.5],'reactions','A197'); 
% % %             xlswrite(strcat('Z:\Taylor\Code\Benchmarking_Extended\RyallHypertrophy_',num2str(count),'.xlsx'),[{'middle'},{'r196'},newEdge(j),1,1.223,0.5],'reactions','A198'); 
% % %             xlswrite(strcat('Z:\Taylor\Code\Benchmarking_Extended\RyallHypertrophy_',num2str(count),'.xlsx'),[{'middle'},{'r197'},newEdge(k),1,1.223,0.5],'reactions','A199'); 
...
newEdge2 = [{'Original Network'},newEdge',{'PKC => PKC; ERBB => ERBB'}];
